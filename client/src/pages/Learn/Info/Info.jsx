    ...
    >
      ...
      <div className="mt-5">
        <h2 className="text-center text-white">
          A-Connection makes your organization-experience
        </h2>
        <h2 className="text-center text-white">
          more fun everywhere and anytime.
        </h2>
        <h6 className="text-center text-white">
          Being part of a student organization is a must-do! It is a unique
          experience which everyone desires.
        </h6>
        <h6 className="text-center text-white">
          However, we know that the experience might get boring or unenjoyable
          if things are not organized well,
        </h6>
        <h6 className="text-center text-white">
          or if organization members are not harmonious. With A-Connect, you
          will make the best out of your organization
        </h6>
      </div>
    </div>
  );
